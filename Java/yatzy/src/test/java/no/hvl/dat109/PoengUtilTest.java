...
public class PoengUtilTest {
	...
	public void testLitenStraight() {
		...
		assertEquals(0, PoengUtil.litenStraight(List.of(1, 2, 3, 4)));
		assertEquals(0, PoengUtil.litenStraight(List.of(1, 2, 3)));
		assertEquals(0, PoengUtil.litenStraight(List.of(1, 2)));
		assertEquals(0, PoengUtil.litenStraight(List.of(1)));
		assertEquals(0, PoengUtil.litenStraight(List.of()));
	...
	public void testStorStraight() {
		...
		assertEquals(0, PoengUtil.storStraight(List.of(2, 3, 4, 5)));
		assertEquals(0, PoengUtil.storStraight(List.of(2, 3, 4)));
		assertEquals(0, PoengUtil.storStraight(List.of(2, 3)));
		assertEquals(0, PoengUtil.storStraight(List.of(2)));
		assertEquals(0, PoengUtil.storStraight(List.of()));
